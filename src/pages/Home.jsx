...
const Home = () => {
  ...
  const visionPoints = [
    "患者さんの人生がより良くなるような、新しい視点や行動が仲間とのつながりから生まれてくる。",
    "現場で一人で悩まず、全国に相談できる仲間がいる安心感を大切にしたい。",
    "理学療法士としての使命感と誇りを、みんなで再確認できる場所にしたい。",
    "みんなでコミュニティと一緒に、ずっと成長し続けていきたい。"
  ]

  const actionGuidelines = [
    "まずは問いかけから始めよう - 否定から入らず、相手の意見を聞いてみる。",
    "いつも学ぶ気持ちで - 新しいことに興味を持って、視野を広げていこう。",
    "お互いを大切に - 他の人の努力や挑戦を認めて、敬意を持って接しよう。",
    "自分の経験をシェアしよう - 知っていることや体験したことを、みんなで共有しよう。",
    "挑戦を楽しもう - 新しいことにチャレンジして、失敗からも学んでいこう。"
  ]
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
              GBCは、若手治療家のみなさんが仲間とのつながりを通じて一緒に成長し、現場でより良い変化を起こしていくことで、患者さんに還元していきたいと考えているコミュニティです。
            </p>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
            GBCで、新しい仲間との出会いと学びを一緒に見つけていきませんか。
          </p>
          <div className="flex justify-center">
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-blue-600 px-8 py-3 text-lg">
